...
model, by six to eight orders of magnitude in the median of each class. Such a gain does not identify its cause. An apparent block-metadata effect is a coupling-kernel effect:
