...
def rational(x):
    ...
    # Integer inputs are exact mathematical data, including values beyond 2^53.
    # Floating inputs retain their actual stored binary64 values.
    return F(int(x)) if isinstance(x,Integral) else F(float(x))
